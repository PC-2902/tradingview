...
###############    ###############  ############### ############### ############### ############### ############### ############### ############### ############### ############### ###############   
    ...
    def chart_btcusd(self):
        ...
        # EFmus
        time.sleep(5)    
        ef1    = self.driver.find_element(By.XPATH,"/html/body/div[2]/div[5]/div[1]/div[1]/div/div[2]/div[3]/div[2]/div/div[2]/div/div[2]/div[2]/div[2]/div/div[1]/div").value_of_css_property("color")
        ef1hex = Color.from_string(ef1).hex
        
        ef2    = self.driver.find_element(By.XPATH,"/html/body/div[2]/div[5]/div[1]/div[1]/div/div[2]/div[3]/div[2]/div/div[2]/div/div[2]/div[2]/div[2]/div/div[2]/div").value_of_css_property("color")
        ef2hex = Color.from_string(ef2).hex
        
        # EMA-Cross
        
        signal     = self.driver.find_element(By.XPATH,"/html/body/div[2]/div[5]/div[1]/div[1]/div/div[2]/div[3]/div[2]/div/div[2]/div/div[2]/div[2]/div[2]/div/div[3]/div").value_of_css_property("color")
        signalhex  = Color.from_string(signal).hex
        
        print("BTCUSD =>")
        print("Efmus    :",ef1hex, ef2hex )
        print("EMA-Cross:",signalhex) 
        self.col_btcusd    = [ef1hex, ef2hex, signalhex]
...
###############    ###############  ############### ############### ############### ############### ############### ############### ############### ############### ############### ###############    
    def chart_btcusdt(self):
        ...
        print("Efmus    :",ef1hex, ef2hex )
        print("EMA-Cross:",signalhex) 
        self.col_btcusdt    = [ef1hex, ef2hex, signalhex]
...
###############    ###############  ############### ############### ############### ############### ############### ############### ############### ############### ############### ###############        
    ...
    def chart_eurusd(self):
        ...
        print("Efmus    :",ef1hex, ef2hex )
        print("EMA-Cross:",signalhex) 
        self.col_eurusd    = [ef1hex, ef2hex, signalhex]
    ...
    def chart_gold(self):
        ...
        print("Efmus    :",ef1hex, ef2hex )
        print("EMA-Cross:",signalhex) 
        self.col_gold    = [ef1hex, ef2hex, signalhex]
...
###############    ###############  ############### ############### ############### ############### ############### ############### ############### ############### ############### ###############    
    ...
    def chart_banknifty(self):
        ...
        print("Efmus    :",ef1hex, ef2hex )
        print("EMA-Cross:",signalhex) 
        self.col_banknifty    = [ef1hex, ef2hex, signalhex]
    ...
    def chart_nifty(self):
        ...
        print("Efmus    :",ef1hex, ef2hex )
        print("EMA-Cross:",signalhex) 
        self.col_nifty    = [ef1hex, ef2hex, signalhex]
